        ...
        success: function(response) {
            ...
            $.each(response, function(p, partida) {
                ...
                eventosCasa = "", $.each(partida.home_team_events, function(ec, ecasa) {
                    ...
                    "substitution-in" == tipoEvento ? eventosCasa += '<li><i class="fas fa-arrow-right green"></i> <strong>' + tempoEvento + "</strong> " + jogadorEvento + "</li>" : "substitution-out" == tipoEvento ? eventosCasa += '<li><i class="fas fa-arrow-left red"></i> <strong>' + tempoEvento + "</strong> " + jogadorEvento + "</li>" : "goal" == tipoEvento ? eventosCasa += '<li><i class="fas fa-futbol"></i> <strong>' + tempoEvento + "</strong> " + jogadorEvento + "</li>" : "goal-penalty" == tipoEvento ? eventosCasa += '<li><i class="fas fa-futbol"></i> <strong>' + tempoEvento + "</strong> " + jogadorEvento + " (P)</li>" : "goal-own" == tipoEvento ? eventosCasa += '<li><i class="fas fa-futbol red"></i> <strong>' + tempoEvento + "</strong> " + jogadorEvento + "</li>" : "yellow-card" == tipoEvento ? eventosCasa += '<li><i class="fas fa-square yellow"></i> <strong>' + tempoEvento + "</strong> " + jogadorEvento + "</li>" : "red-card" == tipoEvento ? eventosCasa += '<li><i class="fas fa-square red"></i> <strong>' + tempoEvento + "</strong> " + jogadorEvento + "</li>" : eventosCasa += "<li><strong>" + tempoEvento + "</strong> " + jogadorEvento + "</li>";
                    ...
                    "substitution-in" == tipoEvento ? eventosFora += "<li>" + jogadorEvento + " <strong>" + tempoEvento + '</strong> <i class="fas fa-arrow-right green"></i></li>' : "substitution-out" == tipoEvento ? eventosFora += "<li>" + jogadorEvento + " <strong>" + tempoEvento + '</strong> <i class="fas fa-arrow-left red"></i></li>' : "goal" == tipoEvento ? eventosFora += "<li>" + jogadorEvento + " <strong>" + tempoEvento + '</strong> <i class="fas fa-futbol"></i></li>' : "goal-penalty" == tipoEvento ? eventosFora += "<li>(P) " + jogadorEvento + " <strong>" + tempoEvento + '</strong> <i class="fas fa-futbol"></i></li>' : "goal-own" == tipoEvento ? eventosFora += "<li>" + jogadorEvento + " <strong>" + tempoEvento + '</strong> <i class="fas fa-futbol red"></i></li>' : "yellow-card" == tipoEvento ? eventosFora += "<li>" + jogadorEvento + " <strong>" + tempoEvento + '</strong> <i class="fas fa-square yellow"></i></li>' : "red-card" == tipoEvento ? eventosFora += "<li>" + jogadorEvento + " <strong>" + tempoEvento + '</strong> <i class="fas fa-square red"></i></li>' : eventosFora += "<li>" + jogadorEvento + " <strong>" + tempoEvento + "</strong></li>";
                }), currentStatus) {
                  case "future":
